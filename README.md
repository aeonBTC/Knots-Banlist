...
<i>Note: Using this banlist will override any existing banlist.json. If you already has entries in your banlist.json, simply add them to this new banlist.json.</i>
