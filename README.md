...
<i>Note: Using this banlist will override any existing banlist.json in your Bitcoin directory. If you already has entries in your banlist.json, simply copy them to the new banlist.json.</i>
